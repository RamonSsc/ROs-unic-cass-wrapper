...
C {rovcel2.sym} 570 -270 0 0 {name=x4}
C {rovcel1_10.sym} 640 -240 0 0 {name=x3}
C {rovcel3.sym} 1010 -210 0 0 {name=x1}
C {rovcel4.sym} 1780 -250 0 0 {name=x2}
C {rovcel2.sym} 1920 -270 0 0 {name=x5}
C {rovcel2.sym} 530 -500 0 1 {name=x6[1:8]}
